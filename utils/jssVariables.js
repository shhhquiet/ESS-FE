//*Timeline Variables */
export const timelineBorderColor = '#a8a8a8';
export const timelineBorderColorLight = '#eae9e9';
export const timelineBoxShadow = '0 .4rem 1rem rgba(0,0,0, .4)';
export const timelineClear = '#f7f7f7';
